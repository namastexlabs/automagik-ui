...
export const CurrentAgentTabContext = createContext<CurrentAgentTabContextValue | null>(null);
export const AgentTabsContext = createContext<AgentTabsContextValue | null>(null);
